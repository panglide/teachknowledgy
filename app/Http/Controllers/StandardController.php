...
class StandardController extends Controller
{
    ...
    public function index(User $user)
    {
      ...
      $data = Pdf::getText('/Users/phillipglidewell/Apps/teachknowledgy/output.pdf', '/usr/local/bin/pdftotext');
    ...
    public function downloadPDF(){
        ...
        $path = "/Users/phillipglidewell/Apps/teachknowledgy/output.pdf";
